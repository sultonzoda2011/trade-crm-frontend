...
export default [
  ...
  layout('routes/(crm)/layout.tsx', [
    ...
    route('/sync/products', 'routes/(crm)/sync/products/route.tsx'),
    route('/sync/transactions', 'routes/(crm)/sync/transactions/route.tsx'),
    route('/sync/debtors', 'routes/(crm)/sync/debtors/route.tsx'),
    route('/sync/categories', 'routes/(crm)/sync/categories/route.tsx'),
    route('/sync/markets', 'routes/(crm)/sync/markets/route.tsx'),
    route('/sync/sellers', 'routes/(crm)/sync/sellers/route.tsx'),

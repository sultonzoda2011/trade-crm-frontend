...
export const ACTION_PERMISSIONS: Record<Action, Role[]> = {
  ...
  [Action.MARKETS_VIEW_BY_ID]: [Role.Admin, Role.Owner, Role.Seller],
  [Action.MY_MARKET]: [Role.Owner, Role.Seller],
  ...
  [Action.CATEGORIES_VIEW]: [Role.Admin, Role.Owner, Role.Seller],

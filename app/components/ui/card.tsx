...
function Card({ className, size = 'default', ...props }: React.ComponentProps<'div'> & { size?: 'default' | 'sm' }) {
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Раньше Card и обёртка DataTable использовали одинаковый
        // rounded-xl+shadow-sm+ring — дашборд/таблицы/модалки визуально не
        // отличались по важности. Card теперь без тени (только ring),
        // таблица (DataTable.tsx) остаётся с shadow-sm — она "тяжелее".
